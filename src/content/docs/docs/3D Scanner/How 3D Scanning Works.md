...
Background for working with the lab's [Creality Raptor Pro](/docs/3d-scanner/3d-scanner-creality-raptor-pro/): when 3D scanning is the right tool, and how the scanner actually captures geometry. Read this before your first scan — the assignments assume it.

## When should I use 3D scanning?
...
## How the scanner sees: infrared vs. LASER

The Creality Raptor Pro operates in three scanning modes: NIR (Near-Infrared) Structured Light, 7 Parallel Blue Laser Lines, and 22 Cross Blue Laser Lines.
...
For the practical side — which mode to pick for a given object, and how the scanner tracks its own position while you move it — see the manual's [Choosing scan and tracking modes](/docs/3d-scanner/3d-scanner-creality-raptor-pro/#choosing-scan-and-tracking-modes) section.
