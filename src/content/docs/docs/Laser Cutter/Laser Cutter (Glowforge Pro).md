...
- You must have **TAMU laser safety certification** — be ready to show it to staff. <!-- TODO: link certification via The Fab Lab Tracker when available -->
- **First-time users must have a staff member present.**
- Only cut **staff-approved materials**: wood, acrylic, cardboard, rubber (lab-provided), and metal (**engraving only**). Material can be brought in or taken from lab stock. Anything else — including materials you can't identify — needs staff approval first. <!-- TODO: link /docs/approved-materials/ once that page exists -->
...
7. Set your material and settings:
   ...
   - Multiple operations (e.g. engrave + cut) run in the order listed, top to bottom — arrange the order deliberately.
