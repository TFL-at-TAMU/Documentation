...
export default defineConfig({
	...
	location.replace(slugged ? '/docs/' + slugged + '/' : '/docs/');
			...
			sidebar: [
				...
				{ label: '3D Scanner', items: [{ autogenerate: { directory: 'docs/3D Scanner' } }] },
				{ label: 'CNC Mill', items: [{ autogenerate: { directory: 'docs/CNC Mill' } }] },
				{ label: 'Cricut', items: [{ autogenerate: { directory: 'docs/Cricut' } }] },
				{ label: 'FDM Printers', items: [{ autogenerate: { directory: 'docs/FDM Printers' } }] },
				{ label: 'Laser Cutter', items: [{ autogenerate: { directory: 'docs/Laser Cutter' } }] },
				{ label: 'PCB Machines', items: [{ autogenerate: { directory: 'docs/PCB Machines' } }] },
				{ label: 'SLA Printers', items: [{ autogenerate: { directory: 'docs/SLA Printers' } }] },
				{ label: 'Templates', items: [{ autogenerate: { directory: 'docs/Templates' } }] },
				{ label: 'Workbenches', items: [{ autogenerate: { directory: 'docs/Workbenches' } }] },
			],
			components: {
